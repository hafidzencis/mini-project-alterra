...
public class CoachServiceTest {
    ...
    public void getAllCoach_Exception_Test(){
        when(coachRepository.findAll()).thenThrow(NullPointerException.class);
        ResponseEntity<Object> responseEntity = coachService.getAllCoach();
        ApiResponse apiResponse = (ApiResponse) responseEntity.getBody();
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR.value(),responseEntity.getStatusCodeValue());
        assertEquals(ResponseMassage.KEY_NOT_FOUND,Objects.requireNonNull(apiResponse).getMessage());
    ...
    @Test
    public void getCoachById_NotFoundId_Test(){
    ...
    @Test
    public void getCoachById_Exception_Test(){
        when(coachRepository.findById(1L)).thenThrow(NullPointerException.class);
        ResponseEntity<Object> responseEntity = coachService.getCoachById(1L);
        ApiResponse apiResponse = (ApiResponse) responseEntity.getBody();
...
//        when(coachRepository.save(any())).thenReturn(coachDao);
    ...
    public void deleteCoachNotFound_Test(){
        ...
        ResponseEntity<Object> responseEntity = coachService.deleteCoach(1L);
        ApiResponse apiResponse = (ApiResponse) responseEntity.getBody();
        assertEquals(HttpStatus.BAD_REQUEST.value(),responseEntity.getStatusCodeValue());
        assertEquals(ResponseMassage.KEY_NOT_FOUND,Objects.requireNonNull(apiResponse).getMessage());
    }
    ...
    public void deleteCoachException_Test(){
        when(coachRepository.findById(anyLong())).thenThrow(NullPointerException.class);
        doNothing().when(coachRepository).delete(any());
